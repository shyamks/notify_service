        ...
        protected List<String> doInBackground(Void... urls) {
            ...
            try {
                ...
                for (int i = 0; i < requestIDs.length(); i++) {
                    if (requestIDs.getJSONObject(i).getString("entityName").equals("LISTING")) {

                        try {
                            url = new URL("http://192.168.124.53:7000/adById?id=" + requestIDs.getJSONObject(i).getLong("entityId"));
